...
export const FoodData= [
      {
        ...
        "price": 13,
        "discount": 10,
        "introduction": "A dish that's fallen out of favour and then become popular again more times than we can count, beef Wellington's origins are as unclear as its connection to Arthur Wellesley, 1st Duke of Wellington. Traditionally, it's a beef fillet steak, coated in pâté and mushroom duxelles (an extremely finely chopped mixture of mushrooms, shallots and herbs), wrapped in puff pastry, then baked. Its modern-day popularity is largely thanks to Gordon Ramsay who's made it one of his signature dishes.",
        "details": [
          { "Cuisine": "British" },
          { "Recipe Type": "Beef" },
          { "Difficulty": "Medium" },
      ...
      },
      {
        ...
        "price": 9,
        "discount": 0,
        "introduction": "This warm, comforting noodle dish has taken the world by storm and rightly so. Its apparent simplicity hides complex flavours that are at once unctuous and refreshing. Born in northern Vietnam in the late 19th century, pho’s development was influenced by Chinese and French cooking, mirroring the history of the country. Today, it is a uniquely Vietnamese offering that you won’t have to go far to find, wherever you are in the world.",
        "details": [
          { "Cuisine": "Vietnamese" },
      ...
      },
      {
        ...
        "price": 17,
        "discount": 0,
        "introduction": "A celebration of spices and rice, biryani's origins lie with the Muslims of the Indian subcontinent. Today, endless varieties of biryani exist, depending on the region where it's cooked and the cook who makes it, but the basics – rice and an assortment of spices – remain untouchable. You can make yours with meat or skip it for a vegan or vegetarian treat. ",
        "details": [
          { "Cuisine": "Indian" },
          { "Recipe Type": "Rice" },
          { "Difficulty": "Easy" },
      ...
      },
      {
        ...
        "recipe": [
          ...
          "Press each ball down into a little cake and fry in olive oil until golden on each side. Serve with the som tam salad and garnish with coriander leaves and crushed peanuts."
        ]
      },
      {
        "id": 15,
